...
@section('page-content')
    ...
    <form action="{{ route('lesson.update', $lesson->id) }}" method="POST" class="row" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control content" name="content" rows="5" id="content" placeholder="Content here..."> {{ $lesson->content }}</textarea>
                            @error('content')
                                <p class="mb-0"><small class="text-danger fs-6">{{ $message }}</small></p>
                            @enderror
                        </div>
